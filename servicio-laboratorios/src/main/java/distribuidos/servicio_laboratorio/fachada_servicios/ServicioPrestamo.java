...
import distribuidos.servicio_laboratorio.acceso_a_datos.repositorio.RepositorioPrestamos;
import distribuidos.servicio_laboratorio.controladores.controladorExcepciones.excepciones.CampoObligatorioVacioException;
import distribuidos.servicio_laboratorio.controladores.controladorExcepciones.excepciones.FechasInvalidasException;
...
import distribuidos.servicio_laboratorio.fachada_servicios.mapper.Mapper; 
...
public class ServicioPrestamo implements ServicioPrestamoInt{
    ...
    public PrestamoDTORespuesta agregarPrestamo(PrestamoDTOPeticion p){
        if( p.getEquipo()==null || p.getEquipo().isBlank() || p.getEstado() == null || p.getEstado().isBlank() 
